...
class MViTxxsEncoderPretrained(nn.Module):
    def __init__(self):
        ...
        self.encoder = MobileViTModel.from_pretrained("model/mobilevit-xx-small", local_files_only=True).base_model # local path to mobilevit-xxs location
...
if __name__ == '__main__':
    ...
    print("flops(G):", flops/1e9, "parameters(M):",params/1e6)